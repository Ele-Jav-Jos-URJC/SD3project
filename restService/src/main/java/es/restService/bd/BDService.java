...
import es.restService.entidades.*;
import es.restService.repositorios.*;
...
/*	//Devuelve un usuario
	...
	inci.setInforme("");*/
		Usuario usuario=null;//getLogUser();
...
/*	SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:ii:ss");
	...
	public Incidencia setIncidenciaByTech(long idIncidencia) {
		...
		Usuario tecnico=null;//getLogUser();
	 ...
	 * @return
	 *****************************************************************************************/
	public List<RolUsuario> getAllRol(){
